...
namespace UpdateTSI
{
    public static class ProcessDTTelemetryUpdatetoTSI
    {
        ...
        public static async Task Run(
            [EventHubTrigger("updatetsi", Connection = "EventHubAppSetting-Twins")] EventData myEventHubMessage,
            [EventHub("pulltsifromdt", Connection = "EventHubAppSetting-TSI")] IAsyncCollector<string> outputEvents,
            ILogger log)
        {
