...
namespace UpdateTSI
{
    public static class ProcessDTTelemetryUpdatetoTSI
    {
        ...
        public static async Task Run(
            [EventHubTrigger("adt_azure_function", Connection = "EventHubAppSetting-Twins")] EventData myEventHubMessage,
            [EventHub("azure_function_time_insights", Connection = "EventHubAppSetting-TSI")] IAsyncCollector<string> outputEvents,
            ILogger log)
        {
            ...
            tsiUpdate.Add("$dtId", dtId);
            tsiUpdate.Add("timestamp", message["timestamp"].ToString());
            tsiUpdate.Add("temperature", value);
