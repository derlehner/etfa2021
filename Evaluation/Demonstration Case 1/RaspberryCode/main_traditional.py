...
CONNECTION_STRING_CCS811 = "HostName=AirQualityIoT.azure-devices.net;DeviceId=RaspiAir01-CCS811;SharedAccessKey=ae88fHX6LSBvugewqOSZ4hLs4n1AomvcoRg4PGTgf1c="
...
def iothub_client_init(sensor_name):
    ...
    if sensor_name == "DHT11":
        client = IoTHubDeviceClient.create_from_connection_string(CONNECTION_STRING_DHT11)
        return client
...
def iothub_client_telemetry_run():
    try:
        ...
        while True:
            ...
            # Sending datas to azure environment
            digital_twin_api.send_telemetry_for_component(DEVICE_ID, 'co2Sensor', "'carbonDioxideValue': {}".format(sensor_CCS811.eco2))
